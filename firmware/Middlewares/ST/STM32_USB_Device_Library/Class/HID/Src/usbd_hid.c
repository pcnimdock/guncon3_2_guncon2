...
if (hid_flag == 1U)
  {
    ...
    for(i=0;i<hid_set_report_size;i++)
    {
    	uint16_t temp;
...
USBD_ClassTypeDef  USBD_HID =
{
  ...
  USBD_HID_Setup,
  NULL, /*EP0_TxSent*/
  USBD_CUSTOM_HID_EP0_RxReady, /*EP0_RxReady*/
...
__ALIGN_BEGIN static uint8_t USBD_HID_CfgFSDesc[USB_HID_CONFIG_DESC_SIZ]  __ALIGN_END =
{
  ...
  0x6a,         /*bInterfaceSubClass : 1=BOOT, 0=no boot*/
                                ...
                                USBD_SetupReqTypedef *req)
{
  ...
  case USB_REQ_TYPE_CLASS :
    ...
    case HID_REQ_SET_REPORT:
    	  hid_flag = 1U;
    	  hid_set_report_size=req->wLength;
    	  USBD_CtlPrepareRx (pdev, data_report, req->wLength);
    	break;
    default:
